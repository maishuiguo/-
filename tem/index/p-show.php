                ...
                <div class="banner">
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div style="background-image: url('../../static/img/p-b1.png');background-size: cover" class="swiper-slide"></div>
                            <div style="background-image: url('../../static/img/p-b1.png');background-size: cover" class="swiper-slide"></div>
                            <div style="background-image: url('../../static/img/p-b1.png');background-size: cover" class="swiper-slide"></div>
                        </div>
                        <!-- Add Pagination -->
                        <!-- Add Arrows -->
                        <div style="background-image:url('../../static/img/p-right.png');width: 0.46rem;height: 0.46rem;border-radius: 0.46rem" class="swiper-button-next"></div>
                        <div style="background-image:url('../../static/img/p-left .png');width: 0.46rem;height: 0.46rem;border-radius: 0.46rem"  class="swiper-button-prev"></div>
                    </div>
                    <img class="tiao" src="../../static/img/p-tiao.png">
